...
class RepresentanteController extends Controller
{
	...
	public function delete($id){
		...
		if(sizeof($representante->empresas) == 0){
			...
			session()->flash("mensagem_erro", 
				"É necessário desvincular	as empresas primeiro!");
			return redirect("/representantes/empresas/$id");
		}
	}
	...
	public function financeiro($id){
		...
		->join('usuarios', 'usuarios.id', '=', 'representantes.usuario_id')
		->orderBy('financeiro_representantes.created_at')
		->where('usuarios.id', $representante->usuario_id)
		->get();
